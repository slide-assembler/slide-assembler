...
[TestClass]
public class FillChartUnitTests
{
    public FileStream template = File.OpenRead("Template.pptx");
    public FileStream templateForMultipleSeries = File.OpenRead("./verificationfiles/Template_all_features.pptx");
    ...
    {
        var fillChart = new FillChart("MesswertDiagramm", null!);
